package cn.six.sup.clay.top4parallax;
...
/**
 * Created by songzhw on 2016-12-28
 */

public class ClayTopImageParallaxDemo extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_clay_parallax_image_top);
