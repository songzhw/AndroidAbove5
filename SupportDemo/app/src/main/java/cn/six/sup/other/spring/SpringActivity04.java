...
// http://hoo.tips/2017/03/25/8cd3930b/
public class SpringActivity04 extends Activity {
    private Button mSignUpBtn;
    private ImageView mLeftLogoImg, mRightLogoImg;
    private TextView mDescTitleTextView;
    private LinearLayout mLettersLayout, mSignInLayout;
