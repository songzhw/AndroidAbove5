package cn.six.sup.rv.expandable.e01;
...
public class ExpandableRvActivity01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerview = (RecyclerView) findViewById(R.id.rvRefresh);
