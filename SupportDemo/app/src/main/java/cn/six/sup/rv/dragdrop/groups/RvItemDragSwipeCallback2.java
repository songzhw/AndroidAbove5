...
*/
public class RvItemDragSwipeCallback2 extends ItemTouchHelper.Callback {
    public RvItemDragSwipeListener2 listener;

    public RvItemDragSwipeCallback2(RvItemDragSwipeListener2 listener) {
